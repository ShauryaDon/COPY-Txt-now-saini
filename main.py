...
photologo = 'https://tinypic.host/image/name-Shaurya-in-Fire-Flames-style.3UqAph' #https://envs.sh/GV0.jpg
photoyt = 'https://tinypic.host/image/name-Shaurya-in-Fire-Flames-style.3UqAph' #https://envs.sh/GVi.jpg
photocp = 'https://tinypic.host/image/name-Shaurya-in-Fire-Flames-style.3UqAph'
...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/@Enquiry_done_by_mebot")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="📞 Contact", url="https://t.me/@Enquiry_done_by_mebot"),
...
image_urls = [
    "https://tinypic.host/image/name-Shaurya-in-Fire-Flames-style.3UqAph",
    "https://tinypic.host/image/name-Shaurya-in-Fire-Flames-style.3UqAph",
...
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        f"🎉Congrats! You are using 🏌 รɦαμ૨ყα 🏌Bot:\n\n"
        ...
        f"**If you have any questions, feel free to ask [🏌 รɦαμ૨ყα 🏌](https://t.me/+bMKgPKEu5P9hYjll)! 💬**\n"
        )
    ) 
...
async def txt_handler(bot: Client, m: Message):
    ...
    if raw_text3 == '1':
        CR = '[🏌 รɦαμ૨ყα 🏌](https://t.me/+bMKgPKEu5P9hYjll)'
    else:
        CR = raw_text3
            ...
            try:
                ...
                if "drive" in url:
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                           ...
                           f"╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [🏌 รɦαμ૨ყα 🏌](https://t.me/+bMKgPKEu5P9hYjll)"
